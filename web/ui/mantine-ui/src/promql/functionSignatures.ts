...
export const functionSignatures: Record<string, Func> = {
  ...
  xdelta: { name: "xdelta", argTypes: [valueType.matrix], variadic: 0, returnType: valueType.vector },
  xincrease: { name: "xincrease", argTypes: [valueType.matrix], variadic: 0, returnType: valueType.vector },
  xrate: { name: "xrate", argTypes: [valueType.matrix], variadic: 0, returnType: valueType.vector },
  ydelta: { name: "ydelta", argTypes: [valueType.matrix], variadic: 0, returnType: valueType.vector },
  year: { name: "year", argTypes: [valueType.vector], variadic: 1, returnType: valueType.vector },
  yincrease: { name: "yincrease", argTypes: [valueType.matrix], variadic: 0, returnType: valueType.vector },
  yrate: { name: "yrate", argTypes: [valueType.matrix], variadic: 0, returnType: valueType.vector },
};
